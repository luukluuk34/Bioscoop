...
namespace BioscoopService
{
    public class Order
    {
        ...
        public IOrderState orderState = new CreatedState();
        ...
        {
            if (orderState.GetType() == typeof(CreatedState) || orderState.GetType() == typeof(UpdateState))
            {
                _tickets.Add(ticket);
            }
        }
